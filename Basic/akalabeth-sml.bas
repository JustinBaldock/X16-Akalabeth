...
16680 IF PA = 1 THEN  PRINT "RETURN TO CONT. ";: INPUT Q$
16690 GOTO 10900
...
17001 PRINT "PRESS RETURN TO CONTINUE";: INPUT Q$: CLS : GOTO 10900
...
60063 PRINT TAB(20):INPUT "(F/M)";PT$
...
62003 REM $0383 HAS CURRENT CURSOR LOCATION
62010 POKE $0383,VTAB
62050 RETURN
...
62310 RECT 0,0,319,199,1: REM WHITE OUT THE SCREEN
62320 RETURN
