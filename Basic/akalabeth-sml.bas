...
4 REM PR# 0: IN# 0
5 CLS: SCREEN($80)
6 GOSUB 62200: REM SETUP MACHINE LANGUAGE FUNCTION
7 GOSUB 60000
8 ZZ =  RND ( -  ABS (LN))
9 LEVEL = 0
...
905 NEXT X
906 GET Q$
1000 SCREEN($80): REM DRAW THE WORLD MAP
1001 FOR Y =  - 1 TO 1
1002  FOR X =  - 1 TO 1
...
10910 VTAB=22: GOSUB 62000: PRINT TAB(30)"FOOD=";PW(0);
10911 VTAB=23: GOSUB 62000: PRINT TAB(30)"H.P.=";C(0);
10912 VTAB=24: GOSUB 62000: PRINT TAB(30)"GOLD=";C(5);
10914 GOSUB 4000
10920 PW(0) =  INT (PW(0) * 10) / 10
10930 IF C(0) <  = 0 THEN 56000
10950 IF IN > 0 THEN  GOSUB 40000: IF C(0) <  = 0 THEN 10930
10960 VTAB=22: GOSUB 62000: PRINT TAB(30)"FOOD=";PW(0);
10961 VTAB=23: GOSUB 62000: PRINT TAB(30)"H.P.=";C(0);
10962 VTAB=24: GOSUB 62000: PRINT TAB(30)"GOLD=";C(5);
...
17001 PRINT TAB(5)"PRESS RETURN TO CONTINUE";: INPUT Q$: CLS : GOTO 10900
...
24010 RECT 0,0,319,10,0
24010 CHAR 10,10,14,"FOOD="+STR$(PW(0))
24020 CHAR 90,10,14,"HIT POINTS="+STR$(C(0))
24030 CHAR 150,10,14,"GOLD="+STR$(C(5))
24050 RETURN
...
60212 IF Q$ = "Q" THEN PRINT "BYE": FOR Z = 1 TO 1000: NEXT: RETURN 
60215 Z =  - 1
