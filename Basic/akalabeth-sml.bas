...
25000 REM FUNDTION - FIND GOLD FOR LINE 11700
25010 PRINT "GOLD!!!!!"
...
26000 REM FUNDTION - FIND TRAP FOR LINE 11600
26010 PRINT "AAARRRGGGHHH!!! A TRAP!"
26020 C(0)=C(0)-INT(RND(1)*INOUT+3): MR=1:INOUT=INOUT+1
26030 PRINT "FALLING TO LEVEL ";IN
26040 RETURN

11600 IF DNG%(PX,PY)=2 THEN  
11601 IF DNG%(PX,PY)=2 THEN 
11602 IF DNG%(PX,PY)=2 THEN  
11603 IF DNG%(PX,PY)=2 THEN 
11604 IF DNG%(PX,PY)=2 THEN : GOSUB 5000: GOTO 10900
