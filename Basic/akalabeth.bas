...
8 ZZ =  RND ( -  ABS (LN))
9 LEVEL = 0
10 PRINT CHR$($13)CHR$($11)CHR$($11)CHR$($11)CHR$($11)CHR$($11)CHR$($11)
11 PRINT CHR$($11)CHR$($11)CHR$($11)CHR$($11)CHR$($11);
12 PRINT " WELCOME TO AKALABETH, WORLD OF DOOM!"
20 DIM DN%(10,10),TE%(20,20),XX%(10),YY%(10),PER%(10,3),LD%(10,5)
25 DIM CD%(10,3),FT%(10,5),LAD%(10,3)
30 FOR X = 0 TO 20
...
60228 IF Q$ = "R" AND PT$ = "M" THEN  PRINT "I'M SORRY MAGES": PRINT "C
     AN'T USE THAT!": GOTO 60210
60229 IF Q$ = "B" AND PT$ = "M" THEN  PRINT "I'M SORRY MAGES": PRINT "C
     AN'T USE THAT!": GOTO 60210
