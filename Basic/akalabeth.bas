...
57070 PRINT : PRINT "         PRESS -SPACE- TO CONT.";: GET Q$: FOR X = 0 TO 5:C(X) = C(X) + 1: NEXT : CLS : GOTO 10900
57500 IF TASK > 0 THEN  PRINT : PRINT : PRINT PN$;" WHY HAST THOU RETURNED?": PRINT "THOU MUST KILL A(N) ";M$(TASK): PRINT "GO NOW AND COMPLETE THY QUEST!": PRINT : PRINT "         PRESS -SPACE- TO CONT.";: GET Q$: CLS : GOTO 10900
...
57530 GOTO 57060
57900 TEXT : CLS : PRINT : PRINT : PRINT :PN$ = "LORD " + PN$: PRINT " ";PN$;","
