...
40 REM PR# 0: IN# 0
50 CLS
60 REM GOSUB 62200: REM SETUP SPECIAL FUNCTION
70 GOSUB 60000
80 ZZ =  RND ( -  ABS (LN))
90 LEVEL = 0
...
5850 GOSUB 20000
5900 RETURN 
10000 PRINT CHR$($13) VTAB=24: GOSUB 62000: PRINT "COMMAND? ";
10001 REM POKE 781,24: SYS 59903
10002 REM CALL  - 868
10003 POKE 781,2: SYS$400
10010 INPUT X$: IF ASC(X$) < 128 THEN 10000 : REM CAN SYS 65487?
10020 Q =  FRE (0)
...
10910 POKE 33,40: VTAB (22): SPC (30): PRINT "FOOD=";PW(0);
10911 CALL  - 868: VTAB (23): SPC (30)
10912 PRINT "H.P.=";C(0);: CALL  - 868: VTAB (24): SPC (30)
10913 PRINT "GOLD=";C(5);: CALL  - 868: POKE 33,29: SPC (1)
10920 PW(0) =  INT (PW(0) * 10) / 10
10930 IF C(0) <  = 0 THEN 6000 **FIX
10950 IF IN > 0 THEN  GOSUB 40000: IF C(0) <  = 0 THEN 10930
10960 POKE 33,40: VTAB (22): SPC (30): PRINT "FOOD=";PW(0);
10961 CALL  - 868: VTAB (23): SPC (30): PRINT "H.P.=";C(0);
10962 CALL  - 868: VTAB (24): SPC (30): PRINT "GOLD=";C(5);
10963 CALL  - 868: POKE 33,29: SPC (1)
...
62210 DATA $9C,$60,$9F,$20,$8E,$C8,$A9,$04,$8D,$60,$9F,$60
62220 FOR I=$400 TO $40B: READ A: POKE I,A: NEXT I
62230 REM POKE 781,2: SYS$400
62240 RETURN
