...
290 REM RANDOM TERRAIN MAP
300 FOR X = 0 TO 20
310  TE%(X,0)=1:TE%(0,X)=1:TE%(X,20)=1:TE%(20,X)=1
320 NEXT X
350 VTAB=23:GOSUB 62000:PRINT "  (PLEASE WAIT)";
390 REM RANDOM INSIDE OF 19 X 19 TERRAIN TILES
400 FOR X=1 TO 19
401  FOR Y=1 TO 19
402   TE%(X,Y)=INT(RND(1)^5*4.5)
410   IF TE%(X,Y)=3ANDRND(1)>.5THENTE%(X,Y)=0
420  NEXT Y
421  PRINT ".";
430 NEXT X
...
45300  GOTO 49980
46000  REMCHECKMONSTERTHEFT
46010  REM50%CHANCEWILLNOSTEALBUTWILLATTACK
