...
3000 PRINT "SKELETON": RETURN
3100 PRINT "THIEF": RETURN
3200 PRINT "GIANT RAT": RETURN
3300 PRINT "ORC": RETURN
3400 PRINT "VIPER": RETURN
3500 PRINT "CARRION CRAWLER": RETURN
3600 PRINT "GREMLIN": RETURN
3700 PRINT "MIMIC": RETURN
3800 PRINT "DAEMON": RETURN
3900 PRINT "BALROG": RETURN
...
10910 PRINT CHR$($93) VTAB=22: GOSUB 62000: PRINT TAB(30)"FOOD=";PW(0);
10911 PRINT CHR$($93) VTAB=23: GOSUB 62000: PRINT TAB(30)"H.P.=";C(0);
10912 PRINT CHR$($93) VTAB=24: GOSUB 62000: PRINT TAB(30)"GOLD=";C(5);
10913 PRINT CHR$($93) VTAB=24: GOSUB 62000: REM POKE 33,29: TAB (1)
10920 PW(0) =  INT (PW(0) * 10) / 10
10930 IF C(0) <  = 0 THEN 56000
10950 IF IN > 0 THEN  GOSUB 40000: IF C(0) <  = 0 THEN 10930
10960 PRINT CHR$($93) VTAB=22: GOSUB 62000: PRINT TAB(30)"FOOD=";PW(0);
10961 PRINT CHR$($93) VTAB=23: GOSUB 62000: PRINT TAB(30)"H.P.=";C(0);
10962 PRINT CHR$($93) VTAB=24: GOSUB 62000: PRINT TAB(30)"GOLD=";C(5);
