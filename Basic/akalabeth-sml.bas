...
3000 REM CHAR 160,100,2, "SKELETON": GOSUB 4000: RETURN

3000 REM DRAW MONSTER ?
3001 LINE C - 23 / DIS,B , C - 15 / DIS,B ,HC%
3002 LINE C - 15 / DIS,B , C - 15 / DI,B - 15 / DI ,HC%
3003 LINE C - 15 / DI,B - 15 / DI , C - 8 / DI,B - 30 / DI,HC% 
3004 LINE C - 8 / DI,B - 30 / DI , C + 8 / DI,B - 30 / DI,HC%
3005 LINE C + 8 / DI,B - 30 / DI , C + 15 / DI,B - 15 / DI,HC%
3006 LINE C + 15 / DI,B - 15 / DI , C + 15 / DI,B ,HC%
3007 LINE C + 15 / DI,B , C + 23 / DI,B,HC%
3010 LINE C,B - 26 / DI , C,B - 65 / DI,HC%
3011 LINE C - 2 / DI + .5,B - 38 / DI , C + 2 / DI + .5,B - 38 / DI,HC%
3012 LINE C - 3 / DI + .5,B - 45 / DI , C + 3 / DI + .5,B - 45 / DI,HC%
3013 LINE C - 5 / DI + .5,B - 53 / DI , C + 5 / DI + .5,B - 53 / DI,HC%
3020 LINE C - 23 / DI,B - 56 / DI , C - 30 / DI,B - 53 / DI,HC%
3021 LINE C - 30 / DI,B - 53 / DI , C - 23 / DI,B - 45 / DI,HC%
3022 LINE C - 23 / DI,B - 45 / DI , C - 23 / DI,B - 53 / DI,HC%
3023 LINE C - 23 / DI,B - 53 / DI , C - 8 / DI,B - 38 / DI,HC%
3030 LINE C - 15 / DI,B - 45 / DI , C - 8 / DI,B - 60 / DI,HC% 
3031 LINE C - 8 / DI,B - 60 / DI , C + 8 / DI,B - 60 / DI,HC%
3032 LINE C + 8 / DI,B - 60 / DI , C + 15 / DI,B - 45 / DI,HC%
3033 LINE C + 15 / DI,B - 42 / DI , C + 15 / DI,B - 57 / DI,HC%
3034 LINE C + 12 / DI,B - 45 / DI , C + 20 / DI,B - 45 / DI,HC%
3040 LINE C,B - 75 / DI , C - 5 / DI + .5,B - 80 / DI,HC%
3041 LINE C - 5 / DI + .5,B - 80 / DI , C - 8 / DI,B - 75 / DI,HC%
3042 LINE C - 8 / DI,B - 75 / DI , C - 5 / DI + .5,B - 65 / DI,HC%
3043 LINE C - 5 / DI + .5,B - 65 / DI , C + 5 / DI + .5,B - 65 / DI,HC%
3044 LINE C + 5 / DI + .5,B - 65 / DI , C + 5 / DI + .5,B - 68 / DI,HC%
3045 LINE C + 5 / DI + .5,B - 68 / DI , C - 5 / DI + .5,B - 68 / DI,HC%
3046 LINE C - 5 / DI + .5,B - 68 / DI , C- 5 / DI + .5,B - 65 / DI,HC%
3050 LINE C- 5 / DI + .5,B - 65 / DI , C + 5 / DI + .5,B - 65 / DI,HC% 
3051 LINE C + 5 / DI + .5,B - 65 / DI , C + 8 / DI,B - 75 / DI,HC%
3052 LINE C + 8 / DI,B - 75 / DI , C + 5 / DI + .5,B - 80 / DI,HC%
3053 LINE C + 5 / DI + .5,B - 80 / DI , C - 5 / DI + .5,B - 80 / DI,HC%
3054 PSET C - 5 / DI + .5,B - 72 / DI,HC%
3055 PSET C + 5 / DI + .5,B - 72 / DI,HC%
3090 GOTO 4900

3100 CHAR 160,100,2, "THIEF": GOSUB 4000:RETURN
3200 CHAR 160,100,2, "GIANT RAT": GOSUB 4000:RETURN
3300 CHAR 160,100,2, "ORC": GOSUB 4000:RETURN
3400 CHAR 160,100,2, "VIPER": GOSUB 4000:RETURN
3500 CHAR 160,100,2, "CARRION CRAWLER": GOSUB 4000:RETURN
3600 CHAR 160,100,2, "GREMLIN": GOSUB 4000:RETURN
3700 CHAR 160,100,2, "MIMIC": GOSUB 4000:RETURN
...
5850 GOSUB 20000
5900 RETURN 
10000 GOSUB 4000: POKE 781,24: SYS $400: REM CLEAR THE LINE
10001 PRINT CHR$($93) VTAB=24: GOSUB 62000: PRINT "COMMAND (N/W/E/S/D/A/-/X)?";
...
10890 PRINT "HUH?": FOR I=1 TO 1000: NEXT I: GOTO 10000
10900 PW(0) = PW(0) - 1 +  SGN (INOUT) * .9
10901 IF PW(0) < 0 THEN C(0) = 0: PRINT "YOU HAVE STARVED!!!!!": GOTO 10930
10910 PRINT CHR$($13) VTAB=22: GOSUB 62000: PRINT TAB(30)"FOOD=";PW(0);
10911 PRINT CHR$($13) VTAB=23: GOSUB 62000: PRINT TAB(30)"H.P.=";C(0);
10912 PRINT CHR$($13) VTAB=24: GOSUB 62000: PRINT TAB(30)"GOLD=";C(5);
10913 PRINT CHR$($13) VTAB=24: GOSUB 62000: REM POKE 33,29: TAB (1)
10914 GOSUB 4000
10920 PW(0) =  INT (PW(0) * 10) / 10
10930 IF C(0) <  = 0 THEN 56000
10950 IF IN > 0 THEN  GOSUB 40000: IF C(0) <  = 0 THEN 10930
10960 PRINT CHR$($13) VTAB=22: GOSUB 62000: PRINT TAB(30)"FOOD=";PW(0);
10961 PRINT CHR$($13) VTAB=23: GOSUB 62000: PRINT TAB(30)"H.P.=";C(0);
10962 PRINT CHR$($13) VTAB=24: GOSUB 62000: PRINT TAB(30)"GOLD=";C(5);
...
11750 IF Z>0 THEN Z=INT(RND(1)*6): PRINT "AND A ";W$(Z): GOSUB 4000
...
16661 IF MZ%(MN,1)<1 THEN GOSUB 22000: GOSUB 4000
...
17001 PRINT "PRESS -CR- TO CONTINUE";: INPUT Q$: CLS : GOTO 10900
...
23000 REM FUNCTION - SWITCH SCREEN
23010 RECT 0,0,319,199,0: REM BLACK OUT THE SCREEN
23020 SCREEN($02)
23030 RETURN
...
56000 POKE 33,40: PRINT : PRINT : PRINT "        WE THE PASSING OF     "
...
57000 REM SCREEN($02): CLS 
57001 GOSUB 62300: CLS: REM WHITE OUT SCREEN AND CLEAR TEXT
...
57040 PRINT "DOEST THOU WISH FOR GRAND ADVENTURE ? ";: INPUT Q$
57041 IF Q$<>"Y" THEN PRINT : PRINT "THEN LEAVE AND BEGONE!":PN$ = "":PRINT
57042 IF Q$<>"Y" THEN PRINT "PRESS -SPACE- TO CONT.";: INPUT Q$: GOTO 10900
57045 PRINT 
...
57070 PRINT : PRINT "PRESS -SPACE- TO CONT.";: INPUT Q$
...
57504 IF TASK > INPUT Q$: CLS : GOTO 10900
...
57530 GOTO 57060
57900 SCREEN($02): CLS : PRINT : PRINT
...
60080 REM FUNCTION ?
60081 SCREEN($02): CLS: PRINT CHR$($13)CHR$($11)CHR$($11)
...
60086 PRINT TAB(18)"Q-QUIT": IF PW(0) > 0 THEN :REM CALL 62450
60087 FOR Z = 0 TO 5
...
60241 PRINT TAB(25 -  LEN ( STR$ (PW(Z))))PW(Z);: PRINT TAB(1)
...
62300 REM FUNCTION CLEAR GRAPHIC SCREEN
62310 SCREEN($80): REM MAKE SURE IN GRAPHIC MODE
62320 RECT 0,0,319,199,1: REM WHITE OUT THE SCREEN
62330 RETURN
